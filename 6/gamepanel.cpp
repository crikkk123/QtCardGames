...
void GamePanel::gameControlInit()
{
    ...
    connect(m_gameCtl,&GameControl::playerStatusChanged,this,&GamePanel::onPlayerStatus);
}
...
void GamePanel::onPlayerStatus(Player *player, GameControl::PlayerStatus status)
{
    switch (status) {
